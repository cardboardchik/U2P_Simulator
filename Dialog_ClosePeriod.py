        ...
        open("data.json", "w").write('''
{
    "input_data": [
        ...
        def create_pdf(company_name, company_num, result, company_names):
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=80, h=125, align="R", txt=f"-{round(result['data']['layoff_charge'][company_num])}  $", border=0)

            # Layoff Charge_%
            sales_percent -= (result['data']['layoff_charge'][company_num] / result['data']['sales'][company_num]) * 100
            
            pdf.set_xy(0, 0)
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=100, h=125, align="R", txt=f"{round((result['data']['layoff_charge'][company_num] / result['data']['sales'][company_num]) * 100)}%", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=185, h=185, align="R", txt=f"{round(result['data']['employees'][company_num])}", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=80, h=0, align="R", txt=f"{round(sum(result['data']['employees']))}    ", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=80, h=0, align="R", txt=f"{round(sum(result['data']['sales']) / sum(result['data']['employees']))}  $", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=80, h=0, align="R", txt=f"{round(sum(result['data']['prod']) / sum(result['data']['employees']))}    ", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=80, h=0, align="R", txt=f"{round(sum(result['data']['capital']))}  $", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=80, h=0, align="R", txt=f"{round((sum(result['decisions']['prod_rate']) / result['player_count']) * 100)} %", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=0, h=0, align="L", txt="UPI", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=46, h=0, align="R", txt=f"{result['data']['upi'][0]}   ", border=0)
            ...
            pdf.set_font("Arial", "", 12)
            pdf.set_text_color(0, 0, 0)
            pdf.cell(w=68.5, h=0, align="R", txt=f"{result['data']['upi'][1]}   ", border=0)
            ...
            if company_names_len not in [2]:
                ...
                pdf.set_font("Arial", "", 12)
                pdf.set_text_color(0, 0, 0)
                pdf.cell(w=91, h=0, align="R", txt=f"{result['data']['upi'][2]}   ", border=0)
            ...
            if company_names_len not in [3, 2]:
                ...
                pdf.set_font("Arial", "", 12)
                pdf.set_text_color(0, 0, 0)
                pdf.cell(w=113.5, h=0, align="R", txt=f"{result['data']['upi'][3]}   ", border=0)
            ...
            if company_names_len not in [4, 3, 2]:
                ...
                pdf.set_font("Arial", "", 12)
                pdf.set_text_color(0, 0, 0)
                pdf.cell(w=136, h=0, align="R", txt=f"{result['data']['upi'][4]}   ", border=0)
            ...
            if company_names_len not in [5, 4, 3, 2]:
                ...
                pdf.set_font("Arial", "", 12)
                pdf.set_text_color(0, 0, 0)
                pdf.cell(w=158.5, h=0, align="R", txt=f"{result['data']['upi'][5]}   ", border=0)
            ...
            if company_names_len not in [6, 5, 4, 3, 2]:
                ...
                pdf.set_font("Arial", "", 12)
                pdf.set_text_color(0, 0, 0)
                pdf.cell(w=181, h=0, align="R", txt=f"{result['data']['upi'][6]}   ", border=0)
            ...
            if company_names_len not in [7, 6, 5, 4, 3, 2]:
                ...
                pdf.set_font("Arial", "", 12)
                pdf.set_text_color(0, 0, 0)
                pdf.cell(w=203.5, h=0, align="R", txt=f"{result['data']['upi'][7]}   ", border=0)
